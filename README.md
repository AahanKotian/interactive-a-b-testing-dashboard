...
A ready-to-use sample file is included: [`sample_data.csv`](sample_data.csv)
...
| 95% CI | The range the true conversion rate difference likely falls within |
| Lift % | Relative improvement of variant over control: `(CVR_B - CVR_A) / CVR_A` |
| Est. power | Probability the test would detect a real effect of this size |
